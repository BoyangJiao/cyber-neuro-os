...
/**
 * PolaroidCamera - based on Polaroid Camera GLB model
 * Uses the same holographic Fresnel shader as CrystalCore
 */
export const PolaroidCamera = () => {
    ...
    const { scene } = useGLTF('/models/polaroid_camera-v2.glb');
...
useGLTF.preload('/models/polaroid_camera-v2.glb');
