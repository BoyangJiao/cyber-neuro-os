...
const CAROUSEL_CONFIG = {
    ...
    BASE_CONTENT_WIDTH: 1000,    // Width threshold for scaling
    BASE_CONTENT_HEIGHT: 500,    // Height threshold for scaling (adjusted for new layout)
    MIN_SCALE: 0.5,
    MAX_SCALE: 1.5,
...
export const ProjectDeck = () => {
    ...
    // Sync rotation when activeProjectId changes
    useEffect(() => {
    ...
    const { BASE_CONTENT_WIDTH, BASE_CONTENT_HEIGHT, MIN_SCALE, MAX_SCALE } = CAROUSEL_CONFIG;
    ...
    useEffect(() => {
        ...
        const updateScale = () => {
            ...
            const heightScale = containerHeight / BASE_CONTENT_HEIGHT;
            const widthScale = containerWidth / BASE_CONTENT_WIDTH;
