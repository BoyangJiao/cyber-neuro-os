    ...
    return (
        <div className="w-full flex flex-col md:flex-row gap-8 lg:gap-16 items-center md:items-start justify-center min-h-[60vh]">
            ...
            <div className="w-[280px] lg:w-[360px] shrink-0 aspect-[3/4] relative z-20">
                <HoloFeatureCard
                    title={app.id.replace('-', ' ').toUpperCase()}
                    icon={app.image}
                    geometryType="lab"
                    subtitle="APP_VISUAL"
                />
            ...
            <div className="flex-1 w-full md:max-w-xl flex flex-col justify-start pt-4 md:pt-12 relative min-w-[300px]">
                ...
                <div className="mb-8 pb-4">
                    <div className="flex flex-col gap-8">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <h2 className="text-4xl lg:text-5xl font-display tracking-[0.1em] text-brand-primary uppercase leading-tight font-bold">
                                {t(app.titleKey)}
                            </h2>
                        </div>

                        {/* Description Text */}
                        <p className="text-base lg:text-lg font-mono tracking-wider text-status-error leading-relaxed opacity-90 text-left">
                            {t(app.descKey)}
                        </p>
                    </div>
                </div>
                ...
                <div className="mt-4 flex justify-start">
                    <CyberButton
                        ...
                        className="w-full sm:w-auto min-w-[240px] text-lg py-4 border-brand-primary/50 text-brand-primary hover:bg-brand-primary hover:text-black transition-all"
