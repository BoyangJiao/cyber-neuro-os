// Extended project detail data for Case Study pages
// This will eventually be managed by Sanity CMS
...
export interface ProjectDetail {
    ...
    // Sidebar Content
    sidebar: {
        role: string;  // Staff / Lead / IC
        team: string;  // "2 PM, 5 Devs" etc.
        timeline: string;  // "2024 - 2025"
        status: 'Live' | 'In Development' | 'Archived';
        liveLink?: string;  // Optional live project URL
        techStack: string[];  // React, WebGL, etc.
        coreContributions: string[];  // 3 short phrases
    };
...
// Placeholder data - will be replaced with Sanity content
